...
(function (e) {
    ...
    var r = function (t, n) {
        ...
        function F() {
            ...
            var i = t.attr("data-position"), s = t.attr("data-in"), u = t.attr("data-delay"), a = t.attr("data-time"), f = t.attr("data-ease-in"), l = t.attr("data-special");
            if (i == null) {
                i = n.position.split(",")
            } else {
                i = i.split(",")
        ...
        function X() {
            ...
            r = r.split(" ");
            var i = n.backgroundX, s = n.backgroundY, o = Number(r[0].replace(/[px,%]/g, "")) + Number(i), u = Number(r[1].replace(/[px,%]/g, "")) + Number(s);
            t.animate({
        ...
        function V() {
            ...
            s.each(function () {
                var t = e(this), n = null, r = null, s = null;
        ...
        function Q() {
            var t = f.innerWidth(), i = f.innerHeight();
            if (t <= u || n.increase) {
                var s = u / a, o = t / s;
